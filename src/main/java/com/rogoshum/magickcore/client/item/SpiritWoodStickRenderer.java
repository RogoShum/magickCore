    ...
    public void func_239207_a_(ItemStack stack, ItemCameraTransforms.TransformType transformType, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLight, int combinedOverlay) {
        ...
        if(transformType != ItemCameraTransforms.TransformType.GROUND) {
            if(transformType == ItemCameraTransforms.TransformType.GUI) {
                ...
                matrixStackIn.rotate(Vector3f.XN.rotationDegrees(30));
        ...
        RenderHelper.renderCubeDynamic(BufferContext.create(matrixStackIn, Tessellator.getInstance().getBuffer(), RenderType.getEntityTranslucent(new ResourceLocation( "minecraft:textures/block/quartz_block_top.png")))

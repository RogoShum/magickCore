...
public class RenderHelper {
    ...
    public static RenderType getTexedOrbSolid(ResourceLocation locationIn) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(NO_TRANSPARENCY).shadeModel(SHADE_ENABLED).alpha(DEFAULT_ALPHA).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Orb_Solid", DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedOrb(ResourceLocation locationIn) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).cull(CULL_DISABLED).transparency(TRANSLUCENT_TRANSPARENCY).shadeModel(SHADE_ENABLED).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Orb", DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedOrbGlow(ResourceLocation locationIn) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).cull(CULL_DISABLED).transparency(LIGHTNING_TRANSPARENCY).shadeModel(SHADE_ENABLED).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Orb_Glow", DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedOrbGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).cull(CULL_DISABLED).transparency(GLINT_TRANSPARENCY).shadeModel(SHADE_ENABLED).alpha(DEFAULT_ALPHA).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).texturing(getEntityGlint(glintScale, glintRotate)).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Orb_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedEntityGlow(ResourceLocation locationIn) {
        ...
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Entity_Glow", DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedEntity(ResourceLocation locationIn) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(TRANSLUCENT_TRANSPARENCY).shadeModel(SHADE_ENABLED).alpha(DEFAULT_ALPHA).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).depthTest(DEPTH_LEQUAL).build(true);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Entity", DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedEntityGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Entity_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedLaserGlint(ResourceLocation locationIn, float glintScale) {
        ...
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Laser_Glint_" + glintScale, DefaultVertexFormats.ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedCylinderGlow(ResourceLocation locationIn) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(LIGHTNING_TRANSPARENCY).shadeModel(SHADE_ENABLED).alpha(DEFAULT_ALPHA).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Cylinder_Glow", DefaultVertexFormats.ENTITY, GL_TRIANGLE_STRIP, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedCylinderGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Cylinder_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormats.ENTITY, GL_TRIANGLE_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedSphereGlow(ResourceLocation locationIn, float glintScale, float glintRotate) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().texture(new RenderState.TextureState(locationIn, false, false)).transparency(LIGHTNING_TRANSPARENCY).shadeModel(SHADE_ENABLED).alpha(DEFAULT_ALPHA).overlay(OVERLAY_ENABLED).cull(CULL_DISABLED).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).texturing(getEntityGlint(glintScale, glintRotate)).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Sphere_Glow_" + glintScale + "_" + glintRotate, DefaultVertexFormats.ENTITY, GL_QUAD_STRIP, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedSphere(ResourceLocation locationIn) {
        ...
        return RenderType.makeType(MagickCore.MOD_ID + "_Textured_Sphere", DefaultVertexFormats.ENTITY, GL_QUAD_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getLineGlow(double width) {
        RenderType.State rendertype$state = RenderType.State.getBuilder().writeMask(COLOR_WRITE).transparency(LIGHTNING_TRANSPARENCY).diffuseLighting(DIFFUSE_LIGHTING_ENABLED).lightmap(LIGHTMAP_ENABLED).shadeModel(SHADE_ENABLED).overlay(OVERLAY_ENABLED).line(new RenderState.LineState(OptionalDouble.of(width))).build(false);
        return RenderType.makeType(MagickCore.MOD_ID + "_LINES", DefaultVertexFormats.ENTITY, GL_LINE_LOOP, 256, false, false, rendertype$state);
    }
    ...
    public static void renderSphere(BufferContext pack, RenderContext renderContext, int stacks) {
        ...
        if(!GL_LIST_INDEX.containsKey(hash)) {
            ...
            for (VertexBuffer vertexBuffer : vertexBuffers) {
                vertexBuffer.bindBuffer();
                DefaultVertexFormats.ENTITY.setupBufferState(0);
                vertexBuffer.draw(matrix4f, GL_QUAD_STRIP);
                VertexBuffer.unbindBuffer();
                DefaultVertexFormats.ENTITY.clearBufferState();
            }
            pack.type.clearRenderState();

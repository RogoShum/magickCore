...
public class MagickItemRecipeCategory {
    /*
     implements IRecipeCategory<MagickWorkbenchRecipe>
    ...
    public MagickItemRecipeCategory(IGuiHelper guiHelper) {
        ...
        this.localizedName = new TranslatableComponent("gui.magickcore.category.magick_crafting").getString();
    }

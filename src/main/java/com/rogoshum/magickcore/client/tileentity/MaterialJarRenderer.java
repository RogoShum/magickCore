...
public class MaterialJarRenderer extends BlockEntityRenderer<MaterialJarTileEntity> {
    ...
    public MaterialJarRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {
...
/*
        ...
        RenderHelper.renderCubeDynamic(BufferContext.create(matrixStackIn, Tesselator.getInstance().getBuffer(), RenderHelper.getTexedOrbSolid(RenderHelper.blankTex))
 ...
 */
        ...
        if(!tile.getStack().isEmpty()) {
            ...
            BakedModel ibakedmodel_ = Minecraft.getInstance().getItemRenderer().getModel(tile.getStack(), null, null);

...
public class ElementWoolRenderer extends BlockEntityRenderer<ElementWoolTileEntity> {
    ...
    public ElementWoolRenderer(BlockEntityRenderDispatcher rendererDispatcherIn) {

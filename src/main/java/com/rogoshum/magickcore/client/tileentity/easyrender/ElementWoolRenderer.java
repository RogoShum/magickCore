...
public class ElementWoolRenderer extends EasyTileRenderer<ElementWoolTileEntity>{
    ...
    public void render(ElementWoolTileEntity tileEntityIn, MatrixStack matrixStackIn, IRenderTypeBuffer.Impl bufferIn, float partialTicks) {
        ...
        RenderHelper.renderStaticParticle(BufferPackage.create(matrixStackIn, buffer, RenderHelper.getTexedOrbSolid(wool)), alpha, color);
        matrixStackIn.pop();
        ...
        matrixStackIn.translate(0.0, 0.0, 1.0);
        matrixStackIn.rotate(Vector3f.YP.rotationDegrees(180));
        RenderHelper.renderStaticParticle(BufferPackage.create(matrixStackIn, buffer, RenderHelper.getTexedOrbGlint(cylinder_rotate, 1f, 0f)), alpha, color);
        matrixStackIn.pop();

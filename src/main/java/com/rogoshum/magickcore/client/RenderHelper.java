...
public class RenderHelper {
    ...
    protected static final RenderStateShard.DiffuseLightingStateShard DIFFUSE_LIGHTING_ENABLED = new RenderStateShard.DiffuseLightingStateShard(true);
    ...
    protected static final RenderStateShard.LineStateShard DEFAULT_LINE = new RenderStateShard.LineStateShard(OptionalDouble.of(6.0D));
    ...
    public static RenderType getTexedOrbSolid(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Orb_Solid", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedParticle(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Particle", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedParticleGlow(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Particle_Glow", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedOrb(ResourceLocation locationIn) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setOutputState(TRANSLUCENT_TARGET)
                ...
                .setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Orb", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedOrbGlow(ResourceLocation locationIn) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setOutputState(TRANSLUCENT_TARGET)
                ...
                .setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Orb_Glow", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedOrbGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Orb_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedEntityGlow(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Entity_Glow", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedEntity(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Entity", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedEntityGlint(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Entity_Glint_Solid", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderStateShard.TexturingStateShard pointState(float size) {
        return new RenderStateShard.TexturingStateShard(MagickCore.MOD_ID+"point_size" + size,
                () -> {
                    if (size != 1) {
                        if (size > 1) {
    ...
    public static RenderType getTexedEntityGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Entity_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getLayerEntityGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        RenderType.CompositeState rendertype$state =
                RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false))
                        ...
                        .setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setCullState(CULL_DISABLED).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED)
                        .setLightmapState(LIGHTMAP_ENABLED).setTexturingState(getEntityGlint(glintScale, glintRotate)).createCompositeState(true);
        return RenderType.create(MagickCore.MOD_ID + ":Layer_Entity_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getLayerEntityGlintSolid(ResourceLocation locationIn, float glintScale, float glintRotate) {
        RenderType.CompositeState rendertype$state =
                RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false))
                        ...
                        .setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setCullState(CULL_DISABLED).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED)
                        .setLightmapState(LIGHTMAP_ENABLED).setTexturingState(getEntityGlint(glintScale, glintRotate)).createCompositeState(true);
        return RenderType.create(MagickCore.MOD_ID + ":Layer_Entity_Glint_Solid_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getLayerEntityGlint(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Layer_Entity_Glint_0.32_10", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedLaserGlint(ResourceLocation locationIn, float glintScale) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false)).setTransparencyState(LIGHTNING_TRANSPARENCY).setOutputState(TRANSLUCENT_TARGET).setShadeModelState(SHADE_ENABLED).setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setCullState(CULL_DISABLED).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setTexturingState(getLaserGlint(glintScale)).createCompositeState(true);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Laser_Glint_" + glintScale, DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedLaser(ResourceLocation locationIn) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Laser", DefaultVertexFormat.NEW_ENTITY, GL_QUADS, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedCylinderGlow(ResourceLocation locationIn) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setOutputState(TRANSLUCENT_TARGET).setShadeModelState(SHADE_ENABLED).setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setCullState(CULL_DISABLED).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Cylinder_Glow", DefaultVertexFormat.NEW_ENTITY, GL_TRIANGLE_STRIP, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedCylinderGlint(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Cylinder_Glint_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_TRIANGLE_STRIP, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getTexedSphereGlow(ResourceLocation locationIn, float glintScale, float glintRotate) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Sphere_Glow_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUAD_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedSphereDepth(ResourceLocation locationIn, float glintScale, float glintRotate) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false)).setTransparencyState(DEPTH_LIGHTNING_TRANSPARENCY).setOutputState(TRANSLUCENT_TARGET).setShadeModelState(SHADE_ENABLED).setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setCullState(CULL_DISABLED).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setTexturingState(getEntityGlint(glintScale, glintRotate)).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Sphere_Depth_" + glintScale + "_" + glintRotate, DefaultVertexFormat.NEW_ENTITY, GL_QUAD_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getTexedSphere(ResourceLocation locationIn) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setOutputState(TRANSLUCENT_TARGET).setShadeModelState(SHADE_ENABLED).setAlphaState(DEFAULT_ALPHA).setOverlayState(OVERLAY_ENABLED).setTexturingState(getEntityGlint(1, 0)).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Textured_Sphere", DefaultVertexFormat.NEW_ENTITY, GL_QUAD_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getLineLoopGlow(double width) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTransparencyState(ADDITIVE_TRANSPARENCY).setWriteMaskState(COLOR_DEPTH_WRITE).setOutputState(TRANSLUCENT_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(width))).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":LINE_LOOP_" + width, DefaultVertexFormat.NEW_ENTITY, GL_LINE_LOOP, 256, false, false, rendertype$state);
    }

    public static RenderType getLineStripGlow(double width) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTransparencyState(ADDITIVE_TRANSPARENCY).setWriteMaskState(COLOR_DEPTH_WRITE).setOutputState(TRANSLUCENT_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(width))).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":LINES_STRIP_" + width, DefaultVertexFormat.NEW_ENTITY, GL_LINE_STRIP, 256, false, false, rendertype$state);
    }

    public static RenderType getLineStripPC(double width) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTransparencyState(ADDITIVE_TRANSPARENCY).setWriteMaskState(COLOR_DEPTH_WRITE).setOutputState(TRANSLUCENT_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(width))).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":LINES_STRIP_PC_" + width, DefaultVertexFormat.POSITION_COLOR, 1, 256, false, false, rendertype$state);
    }
    public static RenderType getLinesGlow(double width) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTransparencyState(ADDITIVE_TRANSPARENCY).setWriteMaskState(COLOR_DEPTH_WRITE).setOutputState(TRANSLUCENT_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING_ENABLED).setLightmapState(LIGHTMAP_ENABLED).setLineState(new RenderStateShard.LineStateShard(OptionalDouble.of(width))).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":LINES_" + width, DefaultVertexFormat.NEW_ENTITY, GL_LINES, 256, false, false, rendertype$state);
    }
    ...
    public static RenderType getPointsGlow(float width) {
        ...
        return RenderType.create(MagickCore.MOD_ID + ":Points_" + width, DefaultVertexFormat.NEW_ENTITY, GL_POINTS, 256, false, false, rendertype$state);
    }

    public static RenderType getDistortion(ResourceLocation locationIn) {
        RenderType.CompositeState rendertype$state = RenderType.CompositeState.builder().setTransparencyState(TRANSLUCENT_TRANSPARENCY).setTextureState(new RenderStateShard.TextureStateShard(locationIn, false, false)).setOutputState(TRANSLUCENT_TARGET).setCullState(CULL_DISABLED).setTexturingState(getEntityGlint(1, 0)).createCompositeState(false);
        return RenderType.create(MagickCore.MOD_ID + ":Distortion", DefaultVertexFormat.POSITION_COLOR_TEX, GL_QUAD_STRIP, 256, rendertype$state);
    }
    ...
    public static void callQuadVertex(BufferContext context, RenderContext renderContext) {
        ...
        if(!GL_LIST_INDEX.containsKey(hash)) {
            ...
            VertexBuffer vertexBuffer = new VertexBuffer(DefaultVertexFormat.ENTITY);
            begin(context);
            ...
            for (VertexBuffer vertexBuffer : vertexBuffers) {
                ...
                DefaultVertexFormat.ENTITY.setupBufferState(0);
                vertexBuffer.draw(matrixStack.getLast().getMatrix(), GL_QUADS);
                VertexBuffer.unbindBuffer();
                DefaultVertexFormat.ENTITY.clearBufferState();
            }
    ...
    public static void renderDistortion(BufferContext pack, RenderContext renderContext, int stacks) {
        ...
        if(!GL_LIST_INDEX.containsKey(hash)) {
            ...
            while (it.hasNext()) {
                Iterator<VertexAttribute> innerIt = it.next().iterator();
                begin(pack);
                VertexBuffer vertexBuffer = new VertexBuffer(DefaultVertexFormat.POSITION_COLOR_TEX);
                while (innerIt.hasNext()) {
                    VertexAttribute vertex = innerIt.next();
            ...
            for (VertexBuffer vertexBuffer : vertexBuffers) {
                vertexBuffer.bind();
                DefaultVertexFormat.POSITION_COLOR_TEX.setupBufferState(0);
    ...
    public static void renderCylinder(BufferContext pack, CylinderContext context) {
        ...
        if(!GL_LIST_INDEX.containsKey(context)) {
            ...
            while (it.hasNext()) {
                Iterator<VertexAttribute> innerIt = it.next().iterator();
                begin(pack);
                VertexBuffer vertexBuffer = new VertexBuffer(DefaultVertexFormat.NEW_ENTITY);
                while (innerIt.hasNext()) {
                    VertexAttribute vertex = innerIt.next();
            ...
            for (VertexBuffer vertexBuffer : vertexBuffers) {
                vertexBuffer.bind();
                DefaultVertexFormat.NEW_ENTITY.setupBufferState(0);
                vertexBuffer.draw(matrix4f, pack.type.mode());
                VertexBuffer.unbind();

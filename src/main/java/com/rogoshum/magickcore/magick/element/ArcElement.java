            ...
            if(flag)
            {
                ...
                for(Entity entity1 : list)
                {
                    if(entity1 instanceof LivingEntity && !ModBuff.hasBuff(entity1, LibBuff.PARALYSIS) &&
                            ((victim instanceof PlayerEntity && entity1 instanceof PlayerEntity) || (!(victim instanceof PlayerEntity) && !(entity1 instanceof PlayerEntity)))) {
                        if(!victim.world.isRemote) {
                            ...
                            starEntity.setTickTime((int) (force * 10));

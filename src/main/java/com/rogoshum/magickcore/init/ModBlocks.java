...
public class ModBlocks {
    ...
    public static RegistryObject<Block> magick_barrier = BLOCKS.register("magick_barrier", () -> new MagickBarrierBlock(AbstractBlock.Properties.create(Material.ICE).doesNotBlockMovement().hardnessAndResistance(3)));
    public static RegistryObject<Block> magick_supplier = BLOCKS.register("magick_supplier", () -> new MagickSupplierBlock(AbstractBlock.Properties.create(Material.WOOD).notSolid().hardnessAndResistance(3)));
    public static RegistryObject<Block> magick_repeater = BLOCKS.register("magick_repeater", () -> new MagickRepeaterBlock(AbstractBlock.Properties.create(Material.WOOD).notSolid().hardnessAndResistance(3)));
    public static RegistryObject<Block> void_sphere = BLOCKS.register("void_sphere", () -> new VoidSphereBlock(AbstractBlock.Properties.create(Material.ICE).doesNotBlockMovement().hardnessAndResistance(3)));

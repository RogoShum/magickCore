...
public class StarStaffItem extends ManaItem {
    ...
    public void inventoryTick(ItemStack p_77663_1_, Level p_77663_2_, Entity p_77663_3_, int p_77663_4_, boolean p_77663_5_) {
        ...
        if(p_77663_3_ instanceof ServerPlayer) {
            AdvancementsEvent.STRING_TRIGGER.trigger((ServerPlayer) p_77663_3_, LibAdvancements.STAR_STAFF);
        }
    }
    ...
    public void fillItemCategory(CreativeModeTab group, NonNullList<ItemStack> items) {
        if(this.allowdedIn(group)) {
            ...
            if(tick > 600)
                tick = 600;
            ManaItem item = this;
            EntityType<? extends IManaEntity> entityType = ModEntities.MANA_STAR.get();

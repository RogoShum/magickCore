...
public class MultiBlockUtil {
    ...
    public static <T> Optional<T>[][][] createBlockPosArrays(HashMap<Vec3i, T> map, Optional<T> empty) {
        if(map.isEmpty()) {
            return null;
        }
    ...
    public static class BlockPattern extends StructurePattern<BlockState>{
        ...
        public boolean match(BlockState state) {
            ...
            return state.getBlock().getDescriptionId().toString().equals(this.name);
        }
    ...
    public static class ItemPattern extends StructurePattern<ItemStack> {
        ...
        public boolean match(ItemStack stack) {
            if(!valid()) return false;
            if(this.itemStack != null && ItemStack.matches(this.itemStack, stack)) return true;
            if(stack.getItem().equals(this.item)) return true;
            return stack.getItem().getDescriptionId().toString().equals(this.name);
        }
    ...
    public static class EntityPattern extends StructurePattern<Entity>{
        ...
        public boolean match(Entity entity) {
            ...
            return entity.getType().getDefaultLootTable().toString().equals(this.name);
        }

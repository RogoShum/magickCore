...
public class GenerationUtil {
    ...
    public static void generateElementFuncFile(String element, String applyType) {
        ...
        pages.add(text);
        json.addProperty("name", new TranslationTextComponent("magickcore.description." + element).getString() + new TranslationTextComponent("magickcore.context." + applyType).getString());
    ...
    public static void generateEntityType(EntityType<?> entityType) {
        String name = "entity_type_" + entityType.getRegistryName().getPath();
        String trigger = "trigger"+"_"+name;

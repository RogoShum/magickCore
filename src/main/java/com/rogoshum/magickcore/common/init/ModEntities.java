...
public class ModEntities {
	...
	public static final RegistryObject<EntityType<ArtificialLifeEntity>> ARTIFICIAL_LIFE = Entities.register(LibEntities.ARTIFICIAL_LIFE, () -> EntityType.Builder.create(ArtificialLifeEntity::new, EntityClassification.MISC).size(1.0F, 1.0F).trackingRange(10).build(LibEntities.ARTIFICIAL_LIFE));
	public static final RegistryObject<EntityType<SpinEntity>> SPIN = Entities.register(LibEntities.SPIN, () -> EntityType.Builder.create(SpinEntity::new, EntityClassification.MISC).size(0.25F, 0.25F).build(LibEntities.SPIN));

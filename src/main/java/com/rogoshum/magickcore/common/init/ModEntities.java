...
public class ModEntities {
	...
	public static final EntityType<MageVillagerEntity> MAGE_ENTITY_TYPE = EntityType.Builder.of(MageVillagerEntity::new, MobCategory.CREATURE).sized(0.6F, 1.95F).clientTrackingRange(10).build(LibEntities.MAGE);

...
public class SpiritCraftingRecipe implements Recipe<MatrixInventory> {
    public static RecipeType<SpiritCraftingRecipe> SPIRIT_CRAFTING;
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<RecipeSerializer<?>>  implements RecipeSerializer<SpiritCraftingRecipe> {
        private static final ResourceLocation NAME = new ResourceLocation(MagickCore.MOD_ID, "spirit_crafting");
        public static final RecipeSerializer<?> INSTANCE = new SpiritCraftingRecipe.Serializer().setRegistryName(NAME);

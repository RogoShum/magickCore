...
public class MagickWorkbenchRecipe implements Recipe<Container> {
    public static RecipeType<MagickWorkbenchRecipe> MAGICK_WORKBENCH;
    ...
    public static class Serializer extends net.minecraftforge.registries.ForgeRegistryEntry<RecipeSerializer<?>>  implements RecipeSerializer<MagickWorkbenchRecipe> {

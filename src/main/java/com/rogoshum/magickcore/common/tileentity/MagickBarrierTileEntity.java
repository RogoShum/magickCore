...
public class MagickBarrierTileEntity extends CanSeeTileEntity implements ITickableTileEntity, IPanelTileEntity, ILifeStateTile, ISpellContext {
    ...
    private void doPlaneThings() {
        ...
        if (center == null) {
            PanelUtil.Plane plane = new PanelUtil.Plane(this.pos, this.panelOutputFirst.pos, this.panelOutputSecond.pos);
        ...
        entityList.forEach((entity -> {
            if (PanelUtil.isEntityTouchPanel(entity, this.pos, this.panelOutputFirst.pos, this.panelOutputSecond.pos, 0.5f)) {
    ...
    public boolean isClosed() {
        return PanelUtil.isPanelClosed(this);
    }

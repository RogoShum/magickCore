...
import com.rogoshum.magickcore.common.magick.ability.WitherAbility;
...
public class BotaniaLoader extends AdditionLoader {
    ...
    public void onLoad(IEventBus eventBus) {
        ...
        functions.add(ApplyType.SUPER, BotaniaAbility::superEntity);
        ...
        functions.add(ApplyType.RADIANCE, BotaniaAbility::radiance);

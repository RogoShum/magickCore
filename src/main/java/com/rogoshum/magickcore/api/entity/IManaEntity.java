...
public interface IManaEntity extends ISpellContext, IOwnerEntity {
    ...
    default void lookAt(Vec3 direction) {
        ...
        entity.xRot = Mth.wrapDegrees((float)(-(Mth.atan2(d1, d3) * (double)(180F / (float)Math.PI))));
        entity.yRot = Mth.wrapDegrees((float)(Mth.atan2(d2, d0) * (double)(180F / (float)Math.PI)) - 90.0F);

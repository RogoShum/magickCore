...
import com.rogoshum.magickcore.entity.ai.task.MagickAttackTask;
import com.rogoshum.magickcore.enums.ApplyType;
import com.rogoshum.magickcore.init.ModEntities;
import com.rogoshum.magickcore.init.ModVillager;
import com.rogoshum.magickcore.lib.LibElements;
import com.rogoshum.magickcore.magick.condition.AlwaysCondition;
import com.rogoshum.magickcore.magick.condition.DistanceCondition;
import com.rogoshum.magickcore.magick.condition.HealthCondition;
...
public class MageVillagerEntity extends VillagerEntity implements IManaTaskMob {
    ...
    public void initSpellMap() {
        ...
        SpellContext orbContext = SpellContext.create().applyType(ApplyType.SPAWN_ENTITY)
                .addChild(SpawnContext.create(ModEntities.ray.get()))
                .tick(100).addChild(ConditionContext.create(AlwaysCondition.ALWAYS)).addChild(new TraceContext()).element(MagickRegistry.getElement(LibElements.VOID));
